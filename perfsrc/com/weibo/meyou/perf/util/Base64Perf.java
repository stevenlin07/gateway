...
public class Base64Perf {
	...
	Base64Perf b64 = new Base64Perf(0, CHUNK_SEPARATOR, urlSafe);
    ...
    public Base64Perf(int lineLength, byte[] lineSeparator, boolean urlSafe){
    ...
    public static byte[] decodeBase64(String base64String){
      Base64Perf b4 = new Base64Perf(0, CHUNK_SEPARATOR, false);
